...
def value_to_ipv4(addr):
    ...
    octets = []
    for i in range(4):
        octets.append(str((addr >> (24 - i * 8)) & 0xff))
    return'.'.join(octets)
...
def ips_same_subnet(ip1, ip2, slash):
    ...
    mask_value = get_subnet_mask_value(slash)

    return (ip1_value & mask_value) == (ip2_value & mask_value)
...
#     print(f"255.255.255.0 = {ipv4_to_value('255.255.255.0')}")
#     print(f"10.0.0.1 = {ipv4_to_value('10.0.0.1')}")
#
#     print("-------------------------------------")
#
#     print("Testing value_to_ipv4:")
#     print(f"4294967040 = {value_to_ipv4(4294967040)}")
#     print(f"167772161 = {value_to_ipv4(167772161)}")
#
#     print("-------------------------------------")
#
#     print("Testing get_subnet_mask_value:")
#     print(f"/24 = {get_subnet_mask_value('/24')}")
#     print(f"/16 = {get_subnet_mask_value('/16')}")
#
#     print("-------------------------------------")
#
#     print("Testing ips_same_subnet:")
#     print(f"10.23.121.17 and 10.23.121.225 with /24: {ips_same_subnet('10.23.121.17', '10.23.121.225', '/24')}")
#     print(f"10.23.230.22 and 10.24.121.225 with /16: {ips_same_subnet('10.23.230.22', '10.24.121.225', '/16')}")
